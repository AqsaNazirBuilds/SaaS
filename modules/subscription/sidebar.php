<?php
include_once(__DIR__ . '/../../config/db.php'); // Path fix kiya hai safety ke liye
...
if (isset($_SESSION['user_id'])) {
    ...
    // Database connection $conn ya $db jo bhi aap use kar rahi hain
...
<div class="sidebar">
    <div class="sidebar-header" style="display: flex; justify-content: space-between; align-items: center; padding-right: 20px;">
        ...
        <div class="notif-wrapper">
            <a href="/SAAS_PROJECT/modules/subscription/reports.php" class="bell-link" title="View Notifications">
